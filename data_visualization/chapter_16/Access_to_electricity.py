...
filename='API_EG.ELC.ACCS.ZS_DS2_en_csv_v2_10580107.csv'
with open(filename,'r', encoding='utf-8')as f:# 这块要多注意
	reader=csv.reader(f)
...
wm.add('0-50',cc_pops_1,)
wm.add('50-90',cc_pops_2)
wm.add('>90',cc_pops_3)
wm.render_to_file('Access to electricity (% of population).svg')
